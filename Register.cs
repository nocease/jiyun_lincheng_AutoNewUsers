...
namespace ConsoleApp1
{
    internal class Register
    {
        ...
        public static string isregister(string phone,int a)
        {
            ...
            string signature =  siteId + "1.9.3" + currentTimeMillis +  phone + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "android";
            if (a == 2)
            {
                signature = siteId + "1.9.3" + phone +  currentTimeMillis + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "android";
            }
        ...
        public static string doMRegis(string phone, string nonce, int a)
        {
            string currentTimeMillis = DateTimeOffset.Now.ToUnixTimeMilliseconds().ToString();
            string signature = "";
            if (a == 1) signature =  siteId + "1.9.3" + currentTimeMillis + phone  + "224e839335d1408a9a2c8d8e2cf2c4e8" + nonce + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 2) signature = siteId + "1.9.3" + currentTimeMillis + phone + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + nonce + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 3) signature =  siteId + "1.9.3" + nonce + phone + currentTimeMillis + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 4) signature =  siteId + "1.9.3" + currentTimeMillis + phone + nonce + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 5) signature = siteId + "1.9.3" + phone +  currentTimeMillis + "224e839335d1408a9a2c8d8e2cf2c4e8" + nonce + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 6) signature = siteId + "1.9.3" + phone +  currentTimeMillis + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + nonce + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 7) signature = siteId + "1.9.3" + nonce + currentTimeMillis +  phone + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            else if (a == 8) signature = siteId + "1.9.3" +  phone + currentTimeMillis + nonce + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + "Androidb2e311cddac73bb6ab39ea42be49518a";
            signature = myUtil.getMD5(signature);
            Ajax ajax1 = new Ajax();
            ajax1.Method = "post";
        ...
        public static string setInviteCode(string userId, int a)
        {
            ...
            else if (a == 9) signature = siteId + versionName + currentTimeMillis + "224e839335d1408a9a2c8d8e2cf2c4e8" + appid + inviteCode + platform + userId;
            signature = myUtil.getMD5(signature);
            Ajax ajax1 = new Ajax();
            ajax1.Url = url;
            ajax1.Method = "POST";
